...
/* 4 */
/*!************************************************!*\
  !*** C:/Users/19737/Desktop/poster/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 20 */
/*!*********************************************************!*\
  !*** C:/Users/19737/Desktop/poster/utils/appletCode.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getWechatCode = getWechatCode;var _base64src = __webpack_require__(/*! @u/base64src.js */ 21);
/**
                                                                                                                                                               ...
                                                                                                                                                               **/
function getWechatCode(url, scene) {
  return new Promise(function (resolve, reject) {
    uni.request({
      url: url,
      method: 'POST',
      ...
      success: function success(res) {
        //将base64图片转换成本地路径
        (0, _base64src.base64src)("data:image/PNG;base64," + res.data.qcode, function (res) {
          // 获取图片信息
          uni.getImageInfo({
            src: res,
            success: function success(res) {
...
/* 22 */
/*!*****************************************************!*\
  !*** C:/Users/19737/Desktop/poster/utils/poster.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.loadImage = loadImage;exports.createPoster = createPoster;exports.canvasToTempFilePath = canvasToTempFilePath;exports.saveImageToPhotosAlbum = saveImageToPhotosAlbum; // 获取图片信息，这里主要要获取图片缓存地址
...
// canvas转image图片
function canvasToTempFilePath(canvasId, vm) {var delay = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 50;
  return new Promise(function (resolve, reject) {
    ...
    setTimeout(function () {
      uni.canvasToTempFilePath({
        canvasId: canvasId,
        success: function success(res) {
          if (res.errMsg && res.errMsg.indexOf('ok') != -1) resolve(res.tempFilePath);else
          reject(res);
        },
        fail: function fail(err) {
          reject(err);
